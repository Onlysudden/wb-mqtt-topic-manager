...
Разработать Python-модуль (библиотеку) для работы с MQTT-брокером,
который полностью инкапсулирует логику топиков в соответствии с конвенцией
...
Пример подключения разделенного подключения к устройству:
...
Пример подключения разделенного подключения к контролам устройствами:
